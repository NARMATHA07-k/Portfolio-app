  ...
  const projects = [
    {
      ...
      technologies: ["HTML", "OpenWeather API", "Tailwind CSS", "Javascript"],
    },
    {
      id: 2,
      title: "Olive-Restaurant Website",
      description: "A simple task manager.",
      link: "https://example.com",
      technologies: ["HTML", "LocalStorage", "Tailwind CSS"],
    },
    {
      id: 3,
    ...
    <div className="min-h-screen w-full bg-gradient-to-b from-white to-gray-50 py-16">
      <div className="max-w-7xl mx-auto px-4 md:px-6 lg:px-8">
        <div className="text-center mb-12">
          <h2 className="text-4xl font-bold bg-gradient-to-r from-green-600 via-blue-600 to-teal-600 bg-clip-text text-transparent">
            My Projects
          </h2>
          ...
          {projects.map((project, index) => (
            ...
            >
              ...
              <a
                href={project.link}
                target="_blank"
                className="inline-flex items-center text-green-600 hover:text-green-800 font-semibold transition-all duration-200"
              >
                View Project
