    ...
    <div className="min-h-screen w-full bg-gradient-to-r from-white to-gray-60 py-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <h2 className="text-4xl font-bold bg-gradient-to-r from-green-700 via-blue-600 to-teal-600 bg-clip-text text-transparent">
            My Skills
          </h2>
        ...
        <div className="flex justify-center mb-12 space-x-4">
          <button
            ...
            className={`px-6 py-3  rounded-lg text-semibold text-lg transition-all duration-200 ${
              skill == "technical"
                ? "bg-gradient-to-r from-green-700 to-blue-700 text-white shadow-lg"
          ...
          <button
            ...
            className={`px-6 py-3  rounded-lg text-semibold text-lg transition-all duration-200 ${
              skill == "soft"
                ? "bg-gradient-to-r from-blue-700 to-green-700 text-white shadow-lg"
            ...
            >
              ...
              <div className="space-y-2">
                ...
                <div className="h-2 bg-gray-200 rounded-full">
                  <div
                    className="h-full bg-gradient-to-r from-blue-600 via-green:600 to-teal-600 rounded-full transition-all duaration-200"
